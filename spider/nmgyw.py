...
# 假设你有一个Python字典
data = [
	{'root' : 'https://inews.nmgnews.com.cn/nmgxw/',
	'url': 'https://inews.nmgnews.com.cn/nmgxw/',
	'area': '内蒙古',
	'code': 'nmg-yw',
	'keyDic': 'us.dic',
	'id': 2}
...
def run(full_config,_config, date):
	...
	if response.status_code == 200:
		...
		result=[]
		#print(content_div)
		rows = soup.find('div',class_='focus_list fr')
		#printInfo(rows)
		...
		for row in newsContent.find_all("li"):
			try:
				...
				if row_id is not None:
					db.insert_data('news_label', 'news_id,label', (row_id, '内蒙古'))					
				if bStart:
